...
const en: Dict = {
  ...
  profile: {
    ...
    avatarDesc: "Build your Mii-style character — it shows up in lobbies, matches and the leaderboard.",
    skin: "Skin",
    head: "Face shape",
    hair: "Hair",
...
const es: Dict = {
  ...
  profile: {
    ...
    avatarDesc: "Crea tu personaje estilo Mii — aparece en salas, partidas y el ranking.",
    skin: "Piel",
    head: "Forma de cara",
    hair: "Pelo",
