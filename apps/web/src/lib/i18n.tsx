...
const en: Dict = {
  ...
  profile: {
    ...
    avatarDesc: "Build your 3D character — outfit, pose and expression show up in lobbies, matches and the leaderboard.",
    skin: "Skin",
    head: "Face shape",
    hair: "Hair",
...
const es: Dict = {
  ...
  profile: {
    ...
    avatarDesc: "Crea tu personaje 3D — su ropa, pose y expresión aparecen en salas, partidas y el ranking.",
    skin: "Piel",
    head: "Forma de cara",
    hair: "Pelo",
